...
struct V8ListSetter
{
	...
	static	void SetListValue(CefRefPtr<CefListValue> list
								, int index,
	...
	static void SetList(CefRefPtr<CefV8Value> source
	...
	static void SetListValue(CefRefPtr<CefV8Value> list
							, int index
	...
	static void SetList(CefRefPtr<CefListValue> source
